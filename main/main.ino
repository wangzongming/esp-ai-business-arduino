...
// ESP-AI 开发版需要做电量检测
    ...
    if (batteryLevel < 10)
    {
        ...
        while (true)
        {
            ...
            mp3_player_write(mei_dian_le, mei_dian_le_len);
        }
...
String on_bind_device(JSONVar data)
{
    ...
    // LOG_D("[Info] loc_api_key: " + loc_api_key);
...
#else
    // ESP-AI 可配置化
    // ESP_AI_i2s_config_mic i2s_config_mic = {mic_bck.toInt(), mic_ws.toInt(), mic_data.toInt(), 16, I2S_CHANNEL_FMT_ONLY_LEFT};
